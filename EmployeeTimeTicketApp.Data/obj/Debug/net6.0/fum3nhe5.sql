...
EXEC sp_rename N'[TimeTickets].[HasBeenPaid]', N'NotPaid', N'COLUMN';
GO
...
UPDATE [Employees] SET [FirstName] = N'' WHERE [FirstName] IS NULL;
ALTER TABLE [Employees] ALTER COLUMN [FirstName] nvarchar(max) NOT NULL;
ALTER TABLE [Employees] ADD DEFAULT N'' FOR [FirstName];
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20221124002549_paymentrename', N'7.0.0');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20221124135800_removeEmployeesFromTimeTickets', N'7.0.0');
GO
